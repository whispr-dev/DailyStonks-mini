...
# Create the stonkplot.py script in the current directory
...
script_path = Path("stonkplot.py")
script_path.write_text(script_code)

print(f"Successfully created {script_path.absolute()}")
print(f"Run it with: python stonkplot.py AAPL")